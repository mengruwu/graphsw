...
def load_rating(args):
    ...
    u_counter, i_counter = {}, {}
    if not os.path.isfile(args.path.data + 'train_pd.csv'):
    ...
    return train_data, eval_data, test_data, user_history_dict, n_item, n_user, n_interaction, avg_u_inte, avg_i_inte
