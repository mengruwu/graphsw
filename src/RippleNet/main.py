...
parser.add_argument('--tolerance', type=int, default=2, help='number of epoch start to count early stop')
...
parser.add_argument('--k_list', type=int, nargs='+', default=[25, 50], help='whether use precision, recall, or ndcg as evaluation method')
